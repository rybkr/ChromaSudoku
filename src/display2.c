...
void display2_show_status(const char *msg){  // can show status of Solved! or Play Again?
    char buf[17];
...
void display2_print_at(uint8_t row, uint8_t col, const char *msg){ //allows us to choose where to print
